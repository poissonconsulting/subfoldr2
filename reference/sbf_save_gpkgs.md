...
- all_sfcs:
  ...
  A flag specifying whether to save non-active sfc columns as
  geopackages.
...
By default (`all_sfcs = TRUE`) non-active sfc columns are saved as
file_name_geometry_column_name.gpkg this includes data frames with no
active sfc column.
