...
Saves meta table descriptions to a database. Its important to note that
if overwrite = TRUE and x includes blank descriptions then existing
non-blank descriptions will be overwritten.
